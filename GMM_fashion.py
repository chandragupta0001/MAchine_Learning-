...
data_set=pd.read_csv("/home/chandragupta/Desktop/fashion.csv")
...
plt.scatter(principalDf.principal_component_1,principalDf.principal_component_2,c=target)
plt.title('Scatter plot Lable for MNIST fashion(original')
...
plt.title('Scatter plot Lable for MNIST fashion dataset (GMM+PCA)')
plt.xlabel('principal component 1')
plt.ylabel('principal component 2')
plt.show()
'''
